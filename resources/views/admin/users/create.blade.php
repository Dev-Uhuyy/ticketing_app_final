<x-layouts.admin title="Tambah User">
    <div class="container mx-auto p-10">
        <div class="card bg-base-100 shadow-sm">
            <div class="card-body">
                <h2 class="card-title text-2xl mb-6">Tambah User Baru</h2>
                ...
                <form action="{{ route('superadmin.users.store') }}" method="POST" class="space-y-4">
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: Ahmad Fauzi" class="input input-bordered w-full @error('name') input-error @enderror" required />
                    ...
                    <div class="form-control">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" placeholder="user@example.com" class="input input-bordered w-full @error('email') input-error @enderror" required />
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" name="no_hp" value="{{ old('no_hp') }}" placeholder="Contoh: 081234567890" class="input input-bordered w-full @error('no_hp') input-error @enderror" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="form-control">
                            ...
                            <input type="password" name="password" placeholder="••••••••" class="input input-bordered w-full @error('password') input-error @enderror" required />
