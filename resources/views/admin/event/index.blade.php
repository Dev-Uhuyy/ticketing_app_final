            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $event->lokasi }}</td>
                        <td>
                            <a href="{{ route('pengelola.events.show', $event->id) }}" class="btn btn-sm btn-info mr-2">Detail</a>
                            <a href="{{ route('pengelola.events.edit', $event->id) }}" class="btn btn-sm btn-primary mr-2">Edit</a>
